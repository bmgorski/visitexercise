...
public class HDOMParser {
	...
	/**
	 * This does the actual work of traversing the DOM tree. This is called by
	 ...
	 *            org.w3c.dom.Element
	 */
	protected void processNode(HDOMVisitor visitor, Node node) throws Exception {
		...
		// --- Unknown node type ---
			...
			System.out
					.println("Unsupported DOM node type in HDOMParser::processNode. Type is: "
							+ nodeClass.getName());
		}
		return;
	}
