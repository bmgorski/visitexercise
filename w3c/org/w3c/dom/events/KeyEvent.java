...
/**
 * The <code>KeyEvent</code> interface provides specific contextual information
...
public interface KeyEvent extends UIEvent {
	...
	/**
	 * The value of <code>keyCode</code> holds the virtual key code value of the
	 * key which was depressed if the event is a key event. Otherwise, the value
	 * is zero.
	 */
	public int getKeyCode();

	/**
	 * <code>charCode</code> holds the value of the Unicode character associated
	 * with the depressed key if the event is a key event. Otherwise, the value
	 * is zero.
	 */
	 ...
	 *            <code>Event</code>.
	 * @param keyCodeArg
	 *            Specifies the <code>Event</code>'s <code>keyCode</code>
	 * @param charCodeArg
	 *            Specifies the <code>Event</code>'s <code>charCode</code>
	 * @param viewArg
	 *            Specifies the <code>Event</code>'s <code>AbstractView</code>.
	 */
	public void initKeyEvent(String typeArg, boolean canBubbleArg,
			boolean cancelableArg, boolean ctrlKeyArg, boolean altKeyArg,
			boolean shiftKeyArg, boolean metaKeyArg, int keyCodeArg,
			int charCodeArg, AbstractView viewArg);
}
