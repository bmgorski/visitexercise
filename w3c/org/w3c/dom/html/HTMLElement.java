 ...
 * interface. These elements are as follows: HEAD special: SUB, SUP, SPAN,
 * BDOfont: TT, I, B, U, S, STRIKE, BIG, SMALL phrase: EM, STRONG, DFN, CODE,
 * SAMP, KBD, VAR, CITE, ACRONYM, ABBRlist: DD, DTNOFRAMES, NOSCRIPTADDRESS,
 * CENTER Note. The <code>style</code> attribute for this interface is part of
 * the . See the <code>HTMLElementCSS</code> interface.
 */
