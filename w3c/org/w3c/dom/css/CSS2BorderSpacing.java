...
public interface CSS2BorderSpacing extends CSSValue {
	 ...
	 *                a float or the value can't be converted.
	 */
	public float getVerticalSpacing(float vType) throws DOMException;
	 ...
	 *                readonly.
	 */
	public void setHorizontalSpacing(short hType, float value)
			throws DOMException;

	/**
	 * This method is used to set the vertical spacing with a specified unit. If
	 * the horizontal value is not a length, it sets the vertical spacing to
	 * <code>0</code>.
	 * 
	 * @param vType
	 *            The vertical unit.
	 ...
	 *                readonly.
	 */
	public void setVerticalSpacing(short vType, float value)
			throws DOMException;
}
