...
public interface CSS2PageSize extends CSSValue {
	 ...
	 */
	public float getWidth(float wType) throws DOMException;
	 ...
	 *                a float or the value can't be converted.
	 */
	public float getHeightSize(float hType) throws DOMException;
	 ...
	 *                readonly.
	 */
	public void setWidthSize(short wType, float value) throws DOMException;

	/**
	 * This method is used to set the height position with a specified unit. If
	 * the <code>widthType</code> is not a length, it sets the width position to
	 * the same value.
	 * 
	 * @param hType
	 *            The height unit.
	 ...
	 *                SYNTAX_ERR: Raises if the identifier has a syntax error
	 *                and is unparsable.
	 * @exception DOMException
	 *                NO_MODIFICATION_ALLOWED_ERR: Raises if this property is
	 *                readonly.
	 */
	public void setIdentifier(String ident) throws CSSException, DOMException;
}
