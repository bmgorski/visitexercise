 ...
 * is empty.
 * <p>
 * The resolution of the children of the <code>Entity</code> (the replacement
 * value) may be lazily evaluated; actions by the user (such as calling the
 * <code>childNodes</code> method on the <code>Entity</code> Node) are assumed
 * to trigger the evaluation.
 * <p>
 * The DOM Level 2 does not support editing <code>Entity</code> nodes; if a user
 ...
 * an <code>Entity</code> node are readonly.
 * <p>
