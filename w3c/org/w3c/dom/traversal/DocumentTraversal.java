...
public interface DocumentTraversal {
	 ...
	 *            description of Iterator for the set of possible values. These
	 *            flags can be combined using OR.These flags can be combined
	 *            using <code>OR</code>.
	 * @param filter
	 ...
	 *            <code>TreeWalker</code>. The currentNode of the TreeWalker is
	 *            set to this node. The whatToShow flags and the NodeFilter are
	 *            not considered when setting this value; any node type will be
	 *            accepted as the root. The root must not be null.
	 * @param whatToShow
	 *            This flag specifies which node types may appear in the logical
	 *            view of the tree presented by the Iterator. See the
	 *            description of TreeWalker for the set of possible values.
	 *            These flags can be combined using OR.These flags can be
	 ...
	 *                Raises the exception NOT_SUPPORTED_ERR if the specified
	 *                root node is null.
	 */
