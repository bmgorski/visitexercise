...
public interface NamedNodeMap {
	 ...
	 *         <code>null</code> if the specified name did not identify any node
	 *         in the map.
	 */
	 ...
	 *            attribute of the node. If a node with that name is already
	 ...
	 *                <code>NamedNodeMap</code>. <br>
	 *                NO_MODIFICATION_ALLOWED_ERR: Raised if this
	 *                <code>NamedNodeMap</code> is readonly. <br>
	 ...
	 * 
	 * @param name
	 *            The name of a node to remove. When this
	 *            <code>NamedNodeMap</code> contains the attributes attached to
	 *            an element, as returned by the attributes attribute of the
	 *            <code>Node</code> interface, if the removed attribute is known
	 ...
	 *            <code>null</code> or an empty string, this method behaves like
	 *            <code>removeNamedItem</code>.
	 * @param name
	 *            The local name of the node to remove. When this
	 *            <code>NamedNodeMap</code> contains the attributes attached to
	 *            an element, as returned by the attributes attribute of the
	 *            <code>Node</code> interface, if the removed attribute is known
	 *            to have a default value, an attribute immediately appears
