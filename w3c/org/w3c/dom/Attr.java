 ...
 * are defined in a documenttype definition.
 * <p>
 ...
 * the <code>nodeValue</code> attribute on the <code>Attr</code> instance can
 ...
 * child nodes of the <code>Attr</code> node provide a representation in which
...
public interface Attr extends Node {
	 ...
	 * this is <code>true</code>; otherwise, it is <code>false</code>. Note that
	 * the implementation is in charge of this attribute, not the user. If the
	 * user changes the value of the attribute (even if it ends up having the
	 * same value as the default value) then the <code>specified</code> flag is
	 * automatically flipped to <code>true</code>. To re-specify the attribute
	 * as the default value from the DTD, the user must delete the attribute.
	 ...
	 * <code>false</code>, and the value is the default value in the DTD. If the
	 ...
	 * Character and general entity references are replaced with their values. <br>
