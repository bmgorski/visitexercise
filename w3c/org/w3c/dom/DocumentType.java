 ...
 * because the effect of namespaces and the various XML scheme efforts on DTD
 * representation are not clearly understood as of this writing.
 * <p>
 * The DOM Level 2 doesn't support editing <code>DocumentType</code> nodes.
 */
public interface DocumentType extends Node {
	 ...
	 * external and internal, declared in the DTD. Duplicates are discarded. For
	 * example in:
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * 
	 * the interface provides access to <code>foo</code> and <code>bar</code>
	 * but not <code>baz</code>. Every node in this map also implements the
	 * <code>Entity</code> interface. <br>
