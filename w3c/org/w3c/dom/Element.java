 ...
 * when traversing a document are <code>Element</code> nodes. Assume the
 ...
 * 
 * <p>
 * When represented using DOM, the top node is a <code>Document</code> node
 * containing an <code>Element</code> node for "elementExample" which contains
 * two child <code>Element</code> nodes, one for "subelement1" and one for
...
public interface Element extends Node {
	 ...
	 *            If the removed <code>Attr</code> has a default value it is
	 ...
	 * and entity references) separates <code>Text</code> nodes, i.e., there are
	 * no adjacent <code>Text</code> nodes. This can be used to ensure that the
	 * DOM view of a document is the same as if it were saved and re-loaded, and
	 * is useful when operations (such as XPointer lookups) that depend on a
	 ...
	 * @since DOM Level 2
	 * @param namespaceURI
	 *            The namespace URI of the attribute to retrieve. When it is
	 ...
	 * URI is already present in the element, its value is changed to be that of
	 * the value parameter. This value is a simple string, it is not parsed as
	 * it is being set. So any markup (such as syntax to be recognized as an
	 ...
	 * assign it as the value of an attribute. HTML-only DOM implementations do
	 * not need to implement this method.
	 * 
	 * @since DOM Level 2
	 * @param namespaceURI
	 *            The namespace URI of the attribute to create or alter. When it
	 *            is <code>null</code> or an empty string, this method behaves
	 *            like <code>getAttribute</code>.
	 * @param localName
	 ...
	 * attribute has a default value it is immediately replaced. HTML-only DOM
	 * implementations do not need to implement this method.
	 * 
	 * @since DOM Level 2
	 * @param namespacURI
	 *            The namespace URI of the attribute to remove. When it is
	 *            <code>null</code> or an empty string, this method behaves like
	 ...
	 * @since DOM Level 2
	 * @param newAttr
	 *            The <code>Attr</code> node to add to the attribute list. When
	 *            the node has no <code>namespaceURI</code>, this method behaves
	 *            like <code>setAttributeNode</code>.
	 * @return If the <code>newAttr</code> attribute replaces an existing
	 ...
	 *                readonly. <br>
	 *                INUSE_ATTRIBUTE_ERR: Raised if <code>newAttr</code> is
	 *                already an attribute of another <code>ElementNS</code>
	 *                object. The DOM user must explicitly clone
	 *                <code>Attr</code> nodes to re-use them in other elements.
	 */
	 ...
	 * starting from this node. HTML-only DOM implementations do not need to
