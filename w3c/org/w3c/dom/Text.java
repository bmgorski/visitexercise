 ...
 * is markup, it is parsed into a list of elements and <code>Text</code> nodes
 ...
 * adjacent <code>Text</code> objects into a single node for each block of text;
 * this is recommended before employing operations that depend on a particular
